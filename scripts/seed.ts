...
async function seed() {
  ...
  await db
    ...
    .values([
      ...
      },
      {
        ...
        description: "Dapat mengelola produk (CRUD)",
      },
      {
        id: 3,
        slug: "manage_users",
      ...
      },
      {
        ...
        description: "Dapat mengelola kategori produk",
      },
      {
        id: 5,
        slug: "manage_brands",
        description: "Dapat mengelola brand produk",
      },
      {
        id: 6,
        slug: "manage_portfolios",
        description: "Dapat mengelola portofolio proyek",
      },
      {
        id: 7,
        slug: "manage_media",
        description: "Dapat mengelola galeri media universal",
      },
      {
        id: 8,
  ...
  await db
    ...
    .values([
      { rolesId: 1, permissionsId: 1 },
      { rolesId: 1, permissionsId: 2 },
      { rolesId: 1, permissionsId: 3 },
      { rolesId: 1, permissionsId: 4 },
      { rolesId: 1, permissionsId: 5 },
      { rolesId: 1, permissionsId: 6 },
  ...
  await db
    .insert(rolesPermissions)
    .values([
      { rolesId: 2, permissionsId: 1 },
      { rolesId: 2, permissionsId: 2 },
      { rolesId: 2, permissionsId: 4 },
      { rolesId: 2, permissionsId: 5 },
  ...
  const mediaAssets: (typeof medias.$inferInsert)[] = [
    ...
    {
      id: 1,
      name: "Panorama Standard Thumb",
      fileKey: "p-std-thumb",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-panorama-standard/padelix-panorama-standard-04a-thumbnail.jpg",
      metadata: { folder: "courts/padelix-panorama-standard" },
    },
    {
      id: 2,
      name: "Panorama Standard 1",
      fileKey: "p-std-1",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-panorama-standard/padelix-panorama-standard-04a-1.jpg",
      metadata: { folder: "courts/padelix-panorama-standard" },
    },
    {
      id: 3,
      name: "Panorama Standard 2",
      fileKey: "p-std-2",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-panorama-standard/padelix-panorama-standard-04a-2.jpg",
      metadata: { folder: "courts/padelix-panorama-standard" },
    },
    ...
    {
      id: 4,
      name: "Panorama Super Thumb",
      fileKey: "p-super-thumb",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-panorama-super/padelix-panorama-super-06a-thumbnail.jpg",
      metadata: { folder: "courts/padelix-panorama-super" },
    },
    {
      id: 5,
      name: "Panorama Super 1",
      fileKey: "p-super-1",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-panorama-super/padelix-panorama-super-06a-1.jpg",
      metadata: { folder: "courts/padelix-panorama-super" },
    },
    {
      id: 6,
      name: "Panorama Super 2",
      fileKey: "p-super-2",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-panorama-super/padelix-panorama-super-06a-2.jpg",
      metadata: { folder: "courts/padelix-panorama-super" },
    },
    ...
    {
      id: 7,
      name: "WPT Standard Thumb",
      fileKey: "p-wpt-thumb",
      type: "image",
      provider: "local",
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-wpt-standard/padelix-wpt-standard-01p-thumbnail.jpeg",
      metadata: { folder: "courts/padelix-wpt-standard" },
    },
    {
      id: 8,
      name: "WPT Standard 1",
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/courts/padelix-wpt-standard/padelix-wpt-standard-01p-1.jpeg",
      metadata: { folder: "courts/padelix-wpt-standard" },
    },
    {
      id: 9,
      ...
      mimeType: "image/png",
      fileSize: 1000,
      url: "/uploads/courts/padelix-wpt-standard/padelix-wpt-standard-01p-2.png",
      metadata: { folder: "courts/padelix-wpt-standard" },
    },
    ...
    // --- Portfolios: Grogol ---
    {
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Grogol, Jakarta Barat/IMG-20250718-WA0089.jpg",
      metadata: { folder: "portofolios/Grogol, Jakarta Barat" },
    },
    {
      id: 11,
      name: "Grogol 2",
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Grogol, Jakarta Barat/IMG-20250718-WA0083.jpg",
      metadata: { folder: "portofolios/Grogol, Jakarta Barat" },
    },
    {
      id: 12,
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Grogol, Jakarta Barat/IMG-20250718-WA0085.jpg",
      metadata: { folder: "portofolios/Grogol, Jakarta Barat" },
    },
    {
      id: 13,
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Grogol, Jakarta Barat/IMG-20250718-WA0084.jpg",
      metadata: { folder: "portofolios/Grogol, Jakarta Barat" },
    },
    ...
    // --- Portfolios: Untar ---
    {
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Universitas Tarua Negara/WhatsApp Image 2025-07-18 at 09.28.50_5c132785.jpg",
      metadata: { folder: "portofolios/Universitas Tarua Negara" },
    },
    {
      id: 15,
      name: "Untar 2",
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Universitas Tarua Negara/WhatsApp Image 2025-07-18 at 09.26.41_b30fa40c.jpg",
      metadata: { folder: "portofolios/Universitas Tarua Negara" },
    },
    {
      id: 16,
      ...
      mimeType: "image/jpeg",
      fileSize: 1000,
      url: "/uploads/portofolios/Universitas Tarua Negara/WhatsApp Image 2025-07-18 at 09.26.38_e842a8ee.jpg",
      metadata: { folder: "portofolios/Universitas Tarua Negara" },
    },
  ];
  ...
  await db.insert(products).values([
    {
      ...
      description:
        "The Padelix Panorama Court features a modern design with high visibility and durability, suitable for clubs and private residences.",
      basePrice: 220000000.0,
      showPrice: false,
      isActive: true,
      isFeatured: true,
    },
    {
      ...
      description:
        "Our premium offering, the Super Panorama Court provides unobstructed views and top-tier materials for the ultimate playing experience.",
    ...
    },
    {
      ...
      description:
        "Official tournament grade specifications. Designed for world-class performance and competition.",
      basePrice: 280000000.0,
      showPrice: true,
      isActive: true,
      isFeatured: true,
    },
  ...
  await db.insert(productSpecifications).values([
    ...
    {
      productId: 2,
      specKey: "Construction",
      specValue: "Reinforced Super Panorama",
    },
  ...
  await db.insert(portfolios).values([
    {
      ...
      description:
        "Successful installation of Padelix courts in the heart of West Jakarta.",
      isActive: true,
      isFeatured: true,
    ...
    },
    {
      ...
      location: "Jakarta",
      description:
        "Modern campus facility installation for students and staff.",
      isActive: true,
      isFeatured: true,
