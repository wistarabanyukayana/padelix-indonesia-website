...
export function EmptyState({ message = "Data belum tersedia", className }: EmptyStateProps) {
  return (
    <div className={cn("flex flex-col items-center justify-center p-8 sm:p-12 w-full h-full min-h-[300px] bg-slate-50/50 rounded-brand border border-dashed border-neutral-300", className)}>
